...
assert_contains_fixed "static constexpr uint8_t MSG_VIDEO_V2 = 0x05;" "$BRIDGE_CPP" "runtime must define timestamped video v2 frame type"
...
assert_contains_fixed "payload[0] = MSG_VIDEO_V2;" "$BRIDGE_CPP" "runtime must send v2 video frames"

echo "video_v2_runtime_contract_test: PASS"
